...
const Header = () => {
    ...
    return (
        ...
        <div className="container-fluid Header_containerTop">
            <nav className={`navbar navbar-expand-md fixed-top ${window.location.pathname.toLowerCase()==='/history' || window.location.pathname.toLowerCase()==='/desk' || window.location.pathname.toLowerCase()==='/objectives' ? window.innerWidth > 729 ? 'Header_history navbar-dark bg-dark': 'Header_mobile-dark navbar-dark bg-dark'  : window.innerWidth > 729 ? 'Header_base navbar-light bg-light': 'Header_mobile-light navbar-light bg-light'}`}>
